...
UPDATE quiz_games SET data = '{
    "topic": [
        {
            "id": 1,
            "name": "Energie solaire",
            "description" : "Produire de l''électricité renouvelable en exploitant la puissance du soleil.",
            "quizzes": [
                {
                    "id": 1,
        ...
        },
        {
            "id": 2,
            "name": "Biodiversite",
            "description": "Assurer l''équilibre des écosystèmes et la survie de la planète.",
            "quizzes": [
                {
                    "id": 3,
                    "topic": "Biodiversite",
        ...
        },
        {
            ...
            "description" : "Altérer les conditions météorologiques mondiales et impacte l''environnement.",
            "quizzes": [
                {
                    "id": 6,
        ...
        },
        {
            ...
            "description" : "Explorer les liens entre organismes marins et environnement, pour préserver les océans.",
            "quizzes": [
                {
                    "id": 9,
        ...
        },
        {
            ...
            "description" : "Préserver des écosystèmes, assurant eau douce, régulation des inondations et biodiversité.",
            "quizzes": [
                {
                    "id": 12,
        ...
        },
        {
            ...
            "description" : "Viser à économiser et gérer cette ressource pour répondre aux besoins présents et futurs.",
            "quizzes": [
                {
                    "id": 15,
